...
function Edit_compet(){
    ...
    const callAboutPage = async () => {
        try{
            ...
            const ppr = await fetch(`/forms/student/s_training/edit/${window.localStorage.getItem('edit')}`,{
                method: "GET",
                headers: {
                    Accept: 'application/json',
                    "Content-Type": "application/json"
            ...
            <div className={`hdr ${sb ? 'activate' : ''}`}>
                    ...
                    <Formik
                        ...
                        onSubmit={(values, { setSubmitting,resetForm }) => {
                            setTimeout(async () => {  
                                ...
                                Axios.put('http://localhost:3000/forms/student/s_training/edit',dat)
                    ...
                    >
                        <Form method="PUT" encType='multipart/form-data' className="form">
                            <h3>Edit Training Programmes / Internship/Field Work</h3>                            
                            ...
                            <MySelect name="training" label="Training / Internship / Field Work">
                                <option value="">--Training / Internship / Field Work--</option>
