...
function Edit_conf(){
    ...
    const callAboutPage = async () => {
        try{
            ...
            const ppr = await fetch(`/forms/student/s_conference/edit/${window.localStorage.getItem('edit')}`,{
                method: "GET",
                headers: {
                    Accept: 'application/json',
                    "Content-Type": "application/json"
            ...
            <div className={`hdr ${sb ? 'activate' : ''}`}>
                    ...
                    <Formik
                        ...
                        onSubmit={(values, { setSubmitting,resetForm }) => {
                            setTimeout(async () => {  
                                ...
                                Axios.put('http://localhost:3000/forms/student/s_conference/edit',dat)
                    ...
                    >
                        <Form method="PUT" encType='multipart/form-data' className="form">
                            <h3>Edit Participation in Workshop/Seminar/Conference/Symposium</h3>                            
