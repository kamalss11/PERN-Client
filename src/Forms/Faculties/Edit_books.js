...
function Edit_books(){
    ...
    const callAboutPage = async () => {
        try{
            ...
            const mo = await fetch(`/forms/faculty/books_published/edit/${window.localStorage.getItem('edit')}`,{
                method: "GET",
                headers: {
                    Accept: 'application/json',
                    "Content-Type": "application/json"
            ...
            <div className="about">
                <div className="content">
                    ...
                    <Formik
                        initialValues = {{
                            name: `${bo ? bo[0].name : ''}`,
                            publisher: `${bo ? bo[0].publisher : ''}`,
                            level: `${bo ? bo[0].level : ''}`,
                            isbn_no: `${bo ? bo[0].isbn_no : ''}`,
                            date: `${bo ? bo[0].date : ''}`,
                            image: ''
                        }}
                        ...
                        onSubmit={(values, { setSubmitting,resetForm }) => {
                            setTimeout(async () => {
                                ...
                                Axios.put('http://localhost:3000/forms/faculty/books_published/edit',dat)
