    ...
    return(
        <div className="iqac">
            ...
            <div className="WordSection1">
                ...
                <h4>5.4 Chapters Contributed ( Total - {rps ? rps.length : '0'} )</h4>
                <table>
                <tbody>
                <tr>
                    <th>S.No</th>
                ...
                {
                    rps ? rps.map((r,i)=>{
                        const {n,file,department,date,title,chapter,editor,venue,publisher,level,isbn_no} = r
                        return(
                            <tr key={i}>
                                <td>{i+1}</td>
                ...
                <div className="table">
                    {
                        ...
                        ]} data={rps} title={`Chapters Contributed ( Total - ${rps ? rps.length : '0'} )`}  />
