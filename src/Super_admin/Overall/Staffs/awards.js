    ...
    return(
        <div className="iqac">
            ...
            <div className="WordSection1">
                ...
                {
                    rps ? rps.map((r,i)=>{
                    const {n,department,awardee_name,designation,award_category,title,awarding_agency,venue,level,date} = r
                        return(
                            <tr key={i}>
                                <td>{i+1}</td>
            ...
            <div className="tables">
                <div style={{display: 'flex',justifyContent: 'space-between',margin: '0 0 15px'}}>
                    ...
                    <Link onClick={e=>window.localStorage.setItem('overall','')} to="/super_admin" style={{color: "red"}}>Back</Link>
                </div>
                <h3>Research</h3>
                ...
                <div className="table">
                    {
                        ...
                        ]} data={rps} title="Awards for Innovation"  />
