    ...
    return(
        <div className="iqac">
            ...
            <div className="WordSection1">
                ...
                <h4>5.2 Faculties qualifying in state/ national/ international level examinations</h4>
                <table>
                <tbody>
                <tr>
                    <th>S.No</th>
                ...
                <div className="table">
                    {
                        ...
                        ]} data={rps} title="Faculties Qualifying in state/ national/ international level examinations"  />
