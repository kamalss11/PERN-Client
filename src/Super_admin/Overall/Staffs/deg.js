    ...
    return(
        <div className="iqac">
            ...
            <div className="WordSection1">
                ...
                <h2>RESEARCH </h2>
                <h4>1.4 Ph. D/M. Phil ( Total - {rps ? rps.length : '0'} )</h4>
                <table>
                <tbody>
                <tr>
                    <th>S.No</th>
                ...
                {
                    rps ? rps.map((r,i)=>{
                        const {n,file,department,deg,guide_name,title,external,venue,date} = r
                        return(
                            <tr key={i}>
                                <td>{i+1}</td>
                ...
                <div className="table">
                    {
                        ...
                        ]} data={rps} title={`Ph.D/M.Phil ( Total - ${rps ? rps.length : '0'} )`}  />
