    ...
    return(
        <div className="iqac">
            ...
            <div className="WordSection1">
                ...
                <h4>1.2 Patents ( Total - {rps ? rps.length : '0'} )</h4>
                <table>
                <tbody>
                <tr>
                    <th>S.No</th>
                ...
                {
                    rps ? rps.map((r,i)=>{
                        const {n,file,department,title,field,fileno,date_awarded_patent,royalty_received,providing_agency,country} = r
                        return(
                            <tr key={i}>
                                <td>{i+1}</td>
                ...
                <div className="table">
                    {
                        ...
                        ]} data={rps} title={`Patents ( Total - ${rps ? rps.length : '0'} )`}  />
