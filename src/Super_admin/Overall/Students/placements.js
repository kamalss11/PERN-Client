...
function Placements(){
    ...
    const call_period = async (prd,value) => {
        try{
            const res = await fetch(`/period/overall/students/${prd}/placements`,{
                method: "GET",
                headers: {
    ...
    const callAboutPage = async () => {
        try{
            ...
            if(datas.user[0].roll != 'SuperAdmin'){
                ...
                const ad = await fetch(`/super_admin/overall/students/placements`,{
                    method: "GET",
                    headers: {
                        Accept: 'application/json',
                        "Content-Type": "application/json"
        ...
        <div className="iqac">
            ...
            <div className="WordSection1">
                ...
                <div style={{textAlign: 'center'}}>
                    ...
                    <h2>Overall Placements - Students Report</h2>
                    {
                        msg ? 
                        <>
                            {msg === 'All' ? 
                ...
                </tr>
                {
                    ...
                    { const {n,file,department,roll_no,company_placed,annual_package,date} = r
                    return(
                        <tr key={i}>
                            <td>{i+1}</td>
            ...
            <div style={{margin: '18px 0',textAlign: 'center',lineHeight: '30px',fontWeight: 'bolder'}}>
                ...
                <p>Overall Placements - Students Report</p>
                {
                    msg ? 
                    <>
                        {msg === 'All' ? 
                ...
                <div className="table">
                    {
                        ...
                        ]} data={placements} title={`Placements ( Total - ${placements ? placements.length : '0'} )`} />
